...
class CISD(object):
    ...
    def __init__(self, molecule, options={}, ncore=4):
        ...
        self.HCISD = self.comp_hcisd(ncore=ncore)
    ...
    def get_dipoles(self, ncore=4):
        mol = self.mol
        if 'dipoles' not in self.mol.properties:
            raise Exception("dipoles are not in the list of properties to be computed.")
        csf_dpy  = self.comp_oeprop(mol.mo_dpy, ncore=ncore)
        csf_dpx  = self.comp_oeprop(mol.mo_dpx, ncore=ncore)
        csf_dpz  = self.comp_oeprop(mol.mo_dpz, ncore=ncore)
        return csf_dpx, csf_dpy, csf_dpz

    def get_quadrupoles(self, ncore=4):
        mol = self.mol
        if 'quadrupoles' not in self.mol.properties:
            raise Exception("quadrupoles are not in the list of properties to be computed.")
        csf_qdxx  = self.comp_oeprop(mol.mo_qdxx, ncore=ncore)
        csf_qdxy  = self.comp_oeprop(mol.mo_qdxy, ncore=ncore)
        csf_qdxz  = self.comp_oeprop(mol.mo_qdxz, ncore=ncore)
        csf_qdyy  = self.comp_oeprop(mol.mo_qdyy, ncore=ncore)
        csf_qdyz  = self.comp_oeprop(mol.mo_qdyz, ncore=ncore)
        csf_qdzz  = self.comp_oeprop(mol.mo_qdzz, ncore=ncore)
        return csf_qdxx, csf_qdxy, csf_qdxz, csf_qdyy, csf_qdyz, csf_qdzz
    ...
    def comp_hcisd(self, ncore=4):
        ...
        if options['singles']:
            ...
            rows_ia = pool_jobs(pfunc_hrow_ia, Plist_ia, ncore)
            hcisd += rows_ia
            P += n_ia
        if options['doubles']:
            if options['doubles_iiaa']:
                ...
                rows_iiaa = pool_jobs(pfunc_hrow_iiaa, Plist_iiaa, ncore)
                hcisd += rows_iiaa
                P += n_iiaa
            if options['doubles_iiab']:        
                n_iiab = num_csfs[3]
                ...
                rows_iiab = pool_jobs(pfunc_hrow_iiab, Plist_iiab, ncore)
                hcisd += rows_iiab
                P += n_iiab
            if options['doubles_ijaa']:
                n_ijaa = num_csfs[4]
                ...
                rows_ijaa = pool_jobs(pfunc_hrow_ijaa, Plist_ijaa, ncore)
                hcisd += rows_ijaa
                P += n_ijaa
            if options['doubles_ijab_A']:
                n_ijab_A = num_csfs[5]
                ...
                rows_ijab_A = pool_jobs(pfunc_hrow_ijab_A, Plist_ijab_A, ncore)
                hcisd += rows_ijab_A
                P += n_ijab_A
            if options['doubles_ijab_B']:        
                n_ijab_B = num_csfs[6]
                ...
                rows_ijab_B = pool_jobs(pfunc_hrow_ijab_B, Plist_ijab_B, ncore)
                hcisd += rows_ijab_B
                P += n_ijab_B
        if P != N:
...
<<<<<<< HEAD
            ...
            Plist_ia = list(range(P, P+n_ia))
            rows_ia = pool_jobs(pfunc_oeprop_ia, Plist_ia, ncore)
=======
...
<<<<<<< HEAD
                ...
                Plist_iiaa = list(range(P, P+n_iiaa))
                rows_iiaa = pool_jobs(pfunc_oeprop_iiaa, Plist_iiaa, ncore)
=======
...
<<<<<<< HEAD
                ...
                Plist_iiab = list(range(P, P+n_iiab))
                rows_iiab = pool_jobs(pfunc_oeprop_iiab, Plist_iiab, ncore)
=======
...
<<<<<<< HEAD
                ...
                Plist_ijaa = list(range(P, P+n_ijaa))
                rows_ijaa = pool_jobs(pfunc_oeprop_ijaa, Plist_ijaa, ncore)
=======
...
<<<<<<< HEAD
                ...
                Plist_ijab_A = list(range(P, P+n_ijab_A))
                rows_ijab_A = pool_jobs(pfunc_oeprop_ijab_A, Plist_ijab_A, ncore)
=======
...
<<<<<<< HEAD
                ...
                Plist_ijab_B = list(range(P, P+n_ijab_B))
                rows_ijab_B = pool_jobs(pfunc_oeprop_ijab_B, Plist_ijab_B, ncore)
=======
